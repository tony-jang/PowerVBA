...
namespace PowerVBA.Core.AvalonEdit.Replace
{

    /// <summary>
    /// FindReplaceDialog.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class FindReplaceDialog : Window
    {
        ...
        public FindReplaceDialog(TextEditor editor)
        {
            ...
            var cb1 = new CommandBinding(ctrlF, OnCtrlFCommand);
            var cb2 = new CommandBinding(ctrlH, OnCtrlHCommand);
        ...
        public static void ShowForReplace(TextEditor editor)
        {
            ...
            {
                if (theDialog.editor != editor) theDialog.editor = editor;
                theDialog.tabMain.SelectedIndex = 1;
                theDialog.Activate();
                theDialog.txtFind2.Focus();
            }
        ...
        public static void ShowForSearch(TextEditor editor)
        {
            if (theDialog == null)
            {
                theDialog = new FindReplaceDialog(editor);
